        ...
        try {
            ...
            switch (methodName) {
                ...
                case "createPostLike":
                    ...
                    break;
                case "deletePostLike":
                    data = Posts.deletePostLike(paramsObject, userId, methodName);
                    break;
                case "createComment":
                ...
                case "getHashtagPosts":
                    data = Posts.getHashtagPosts(paramsObject, userId, methodName);
                    break;
                case "getDiscoverFeed":
                    data = Posts.getDiscoverFeed(paramsObject, userId, methodName);
                    break;
                case "createPostHashtags":
                    data = Posts.createPostHashtags(paramsObject, userId, methodName);
                    break;
                case "createPostTag":
                    data = Posts.createPostTag(paramsObject, userId, methodName);
                    break;
                default: {
